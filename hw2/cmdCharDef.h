...
enum ParseChar
{
   ...
   //
   BACK_SPACE_KEY   = 127, // TODO

   //
   // -- Arrow keys: 27 -> 91 -> {UP=65, DOWN=66, RIGHT=67, LEFT=68}
   ARROW_KEY_FLAG   = 1 << 8,
   ARROW_KEY_INT    = 91,
   ARROW_UP_KEY     = 61, // = 65 + ARROW_KEY_FLAG,
   ARROW_DOWN_KEY   = 93, // ] 66 + ARROW_KEY_FLAG,
   ARROW_RIGHT_KEY  = 92, // \ 67 + ARROW_KEY_FLAG,
   ARROW_LEFT_KEY   = 91, // [ 68 + ARROW_KEY_FLAG,
   ...
   MOD_KEY_FLAG     = 1 << 9,
   MOD_KEY_INT      = 91,
   HOME_KEY         = 6, // Ctrl+F 49 + MOD_KEY_FLAG,
   INSERT_KEY       = 7, // Ctrl+G 50 + MOD_KEY_FLAG,
   DELETE_KEY       = 8, // Ctrl+H 51 + MOD_KEY_FLAG,
   END_KEY          = 11, // Ctrl+K 52 + MOD_KEY_FLAG,
   PG_UP_KEY        = 12, // Ctrl+L 53 + MOD_KEY_FLAG,
   PG_DOWN_KEY      = 13, // Ctrl+M 54 + MOD_KEY_FLAG,
